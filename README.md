...
3. **自由法术** — 9 元素 × 5 形式 × 5 效果 × 5 修饰的组合法术引擎。九元素各有专属机制(不全是伤害:火点燃、冰霜冻、雷链、自然骨粉/毒、暗影致盲隐身、神圣克亡灵群疗、鲜血吸血换蓝、末影传送漂浮、奥术印记夜视),debuff/utility 九格效果互不重复;单发伤害对标同档武器(power×3.0,模板 power=2×(档位+1))。法杖/魔法书是**增幅器**(法术伤害 +%、法力上限 +X,主手+副手同时生效、效果叠加),不再承载法术;法术本体来自**炼金台**:摆材料或问 AI 炼出魔法卷轴(~26 种模板,含双算子组合技,AI 可生成专属法术) → 右键学习进已学列表 → 按住 V 弹出轮盘,指向扇区松开即施放(点按 V 快速施放上次法术)。
